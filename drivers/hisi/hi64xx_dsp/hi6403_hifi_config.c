				...
				enum bustype_select bus_sel)
{
	...
	dsp_config.ir_switch_gpio = HI6403_IR_GPIO;
	dsp_config.ana_rwreg_106 = HI6403_CODEC_ANA_RWREG_106;
	dsp_config.ana_rwreg_106_ocp = HI6403_CODEC_ANA_RWREG_106_OCP_BIT;
