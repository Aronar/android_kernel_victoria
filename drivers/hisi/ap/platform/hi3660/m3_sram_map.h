...
#define SYS_CODE_SEC_SIZE (0x11840-SYS_CODE_SEC_RESERVED_SIZE)
...
#define SYS_BSS_SEC_SIZE (0x31c0-SYS_BSS_SEC_RESERVED_SIZE)
...
#if ((PRIVATE_DATA_SRAM_BASE + PRIVATE_DATA_SRAM_SIZE) > (OVERLAPPING_AREA_BASE + OVERLAPPING_AREA_SIZE))
#error "OVERLAPPING_AREA overflow!!!"
#endif
