...
/*** Reliability events' keys ***/
	...
	/* Event 901002103
		TrustedZone:tz Crash */
	/* Process Name */
	#define E901002103_PNAME_VARCHAR 0
	/* 1st fuction in stack */
	#define E901002103_F1NAME_VARCHAR 1
	/* Interrupt Time Type */
	#define E901002103_INTTIMETYPE_VARCHAR 2
	...
	/* Process Name */
	#define E901002005_PNAME_VARCHAR 0
	/* 1st fuction in stack */
	#define E901002005_F1NAME_VARCHAR 1
	/* Interrupt Time Type */
	#define E901002005_INTTIMETYPE_VARCHAR 2

	/* Event 901002010
		Othersubsystem Crash */
	/* Process Name */
	#define E901002010_PNAME_VARCHAR 0
	/* 1st fuction in stack */
	#define E901002010_F1NAME_VARCHAR 1
	/* Interrupt Time Type */
	#define E901002010_INTTIMETYPE_VARCHAR 2
	...
	/* Event 901004003
		Service Die */
	/* Process Name */
	#define E901004003_PNAME_VARCHAR 0
	/* 1st fuction in stack */
	#define E901004003_F1NAME_VARCHAR 1
	/* Interrupt Time Type */
	#define E901004003_INTTIMETYPE_VARCHAR 2
	...
	/* Event 901006000
		Hung task Detector */
	/* PID of D-State Task */
	#define E901006000_PID_INT 0
	/* TGID of D-State Task */
	#define E901006000_TGID_INT 1
	/* NAME of D-State Task */
	#define E901006000_NAME_VARCHAR 2
	/* TYPE of D-State Task */
	#define E901006000_TYPE_INT 3
...
/*** PowerThermal events' keys ***/
	...
	/* bg gps high power apps */
	#define E903001024_BGGPSAPP_VARCHAR 8
	/* bg sensor high power apps */
	#define E903001024_BGSENSORAPP_VARCHAR 9
	/* auto start to the foreground when screen off */
	#define E903001024_AUTOFGSCROFF_VARCHAR 10
	/* bg send data packets frequently */
	#define E903001024_BGSENDDATAAPP_VARCHAR 11
	...
	/* Event 903002011
		Application power consumption abnormal information */
	/* Start Time */
	#define E903002011_STARTTIME_DATETIME 0
	/* End Time */
	#define E903002011_ENDTIME_DATETIME 1
	/* Abnormal module information */
	#define E903002011_ABNORMALINFORMATION_VARCHAR 2
	...
	/* Event 903003001
		NFF OnTrack Info */
	/* The stats start time */
	#define E903003001_FROMTIME_DATETIME 0
	/* The stats end time */
	#define E903003001_TOTIME_DATETIME 1
	/* The full design bat capacity */
	#define E903003001_FULLDESIGNBATCAPACITY_INT 2
	/* The real bat capacity */
	#define E903003001_REALBATCAPACITY_INT 3
	/* The battery capacity qualified ratio */
	#define E903003001_BATCAPQUALIFIEDRATIO_INT 4
	/* Total battery drop */
	#define E903003001_TOTALBATDROP_INT 5
	/* Screen on time (In second) */
	#define E903003001_SCRNONTIME_INT 6
	/* Screen on qulified time (In second) */
	#define E903003001_SCRNONQUALIFIEDTIME_INT 7
	/* PowerGenie Power saving mode */
	#define E903003001_PGPOWERMODE_INT 8
	/* Modemlog opened times */
	#define E903003001_MODEMLOGOPENEDTIMES_INT 9
	/* AOD switch opened times */
	#define E903003001_AODOPENEDTIMES_INT 10
	/* Wifi Connected policy */
	#define E903003001_WIFICONNECTEDPOLICY_INT 11
	/* Time on battery realtime */
	#define E903003001_TIMEONBATREALTIME_INT 12
	/* Time on battery scrn off realtime */
	#define E903003001_TIMEONBATSCRNOFFREALTIME_INT 13
	/* Time on battery scrn off uptime */
	#define E903003001_TIMEONBATSCRNOFFUPTIME_INT 14
	/* Amount discharge while screen on */
	#define E903003001_AMOUNTDISCHGWHILESCRNON_INT 15
	/* Amount discharge while screen off */
	#define E903003001_AMOUNTDISCHGWHILESCRNOFF_INT 16
	/* Every hour bat drop */
	#define E903003001_EVERYHOURBATDROP_VARCHAR 17
	/* RealTime Battery Level */
	#define E903003001_REALTIMEBATLEVEL_VARCHAR 18
	/* RealTime Charge State */
	#define E903003001_REALTIMECHARGESTATE_VARCHAR 19
	/* GPS long time used apk */
	#define E903003001_GPSLTUSEDAPK_VARCHAR 20
	/* WakeLock long time used apk */
	#define E903003001_WAKELOCKLTUSEDAPK_VARCHAR 21
	/* Alarm frequently used Apk */
	#define E903003001_ALARMFREQUSEDAPK_VARCHAR 22
	/* Foreground High Power usage app */
	#define E903003001_FGHIGHPOWERUSEAPK_VARCHAR 23
	/* Background High Power usage app */
	#define E903003001_BGHIGHPOWERUSEAPK_VARCHAR 24
	/* User long time used apk */
	#define E903003001_USRLTUSEDAPK_VARCHAR 25
	/* Screen on battery drop */
	#define E903003001_SCRNONBATDROP_INT 26
	/* Screen off time (In second) */
	#define E903003001_SCRNOFFTIME_INT 27
	/* Screen off battery drop */
	#define E903003001_SCRNOFFBATDROP_INT 28
	/* Phone calling time(In second) */
	#define E903003001_CALLTIME_INT 29
	/* Every Hour LCD Power consume */
	#define E903003001_EVERYHOURLCDPOWERCONSUME_VARCHAR 30
	/* Wifi AP open time(In second) */
	#define E903003001_WIFIAPOPENTIME_INT 31
	/* Backlight auto mode opened times */
	#define E903003001_BKLIGHTAUTOMODEOPENTIMES_INT 32
	/* Power saving mode opened times */
	#define E903003001_POWERSAVINGMODEOPENTIMES_INT 33
	/* Low Resolution Opened times */
	#define E903003001_LOWRESOLUTIONOPENTIMES_INT 34
	/* Mobile data always connect times */
	#define E903003001_MOBILEDATAALWAYSCONTIMES_INT 35
	/* Kill abnormal app state open times */
	#define E903003001_KILLABNORMALAPPOPENTIMES_INT 36
	/* Unkilled pkg list while screen is locked */
	#define E903003001_SRNLOCKUNKILLEDPKGLIST_VARCHAR 37
	/* Auto start App package name list */
	#define E903003001_AUTOSTARTPKGLIST_VARCHAR 38

	/* Event 903009000
		Statistics of charger */
	/* charger type 0: USB 1: BC_USB 2: NON STANDARD 3: STANDARD
		4: FCP 5: REMOVED 6: OTG_ID 7: DIRECT */
	#define E903009000_CHARGERTYPE_TINYINT 0
	/* battery manufactor id */
	#define E903009000_BATTERYMANUFACTOR_TINYINT 1
	/* battery model manufactor id */
	#define E903009000_BATTERYMODEL_TINYINT 2
	/* battery capacity, in mAh */
	#define E903009000_BATTERYCAPACITY_SMALLINT 3
	/* battery terminate voltage, in mV */
	#define E903009000_BATTERYTERMVOLT_SMALLINT 4
	/* battery terminate current, in mA */
	#define E903009000_BATTERYTERMCURR_SMALLINT 5
	/* battery capacity caculated by FG, in mAh */
	#define E903009000_CAPFCC_SMALLINT 6
	/* charging cycles */
	#define E903009000_CHGCYCLES_TINYINT 7
	/* charging terminate setting voltage, in mV */
	#define E903009000_BATTERYTERMVOLTSETTING_SMALLINT 8
	/* charging terminate setting current, in mA */
	#define E903009000_BATTERYTERMCURRSETTING_SMALLINT 9
	/* battery internal resistor average */
	#define E903009000_AVGRBAT_INT 10
	/* battery internal resistor max */
	#define E903009000_MAXRBAT_INT 11
	/* charger plugin time */
	#define E903009000_CHARGERPLUGINTIME_DATETIME 12
	/* charger plugout time */
	#define E903009000_CHARGERPLUGOUTTIME_DATETIME 13
	/* start charging time */
	#define E903009000_CHARGINGSTARTTIME_DATETIME 14
	/* charging terminate time */
	#define E903009000_CHARGINGTERMINALTIME_DATETIME 15
	/* the time FG report 100% */
	#define E903009000_CHARGINGENDTIME_DATETIME 16
	/* CC step start time */
	#define E903009000_CCSTARTTIME_DATETIME 17
	/* CC step quit time */
	#define E903009000_CCENDTIME_DATETIME 18
	/* charging error no */
	#define E903009000_CHARGINGSTATE_INT 19
	/* charging stop times */
	#define E903009000_CHARGINGSTOPPEDTIMES_TINYINT 20
	/* start soc, in % */
	#define E903009000_STARTSOC_TINYINT 21
	/* end soc, in % */
	#define E903009000_ENDSOC_TINYINT 22
	/* start UI soc, in % */
	#define E903009000_STARTUISOC_TINYINT 23
	/* end UI soc, in % */
	#define E903009000_ENDUISOC_TINYINT 24
	/* vbat start voltage, in mV */
	#define E903009000_STARTVBAT_SMALLINT 25
	/* vbat end voltage, in mV */
	#define E903009000_ENDVBAT_SMALLINT 26
	/* VBUS min value, in mV */
	#define E903009000_MINVBUS_SMALLINT 27
	/* VBUS max value, in mV */
	#define E903009000_MAXVBUS_SMALLINT 28
	/* ibus average value, in mA */
	#define E903009000_IBUSAVG_SMALLINT 29
	/* ibus min value, in mA */
	#define E903009000_IBUSMIN_SMALLINT 30
	/* ibus max value, in mA */
	#define E903009000_IBUSMAX_SMALLINT 31
	/* battery start temp, in degree */
	#define E903009000_BATTERYSTARTTEMP_TINYINT 32
	/* battery max temp, in degree */
	#define E903009000_BATTERYMAXTEMP_TINYINT 33
	/* battery Min temp, in degree */
	#define E903009000_BATTERYMINTEMP_TINYINT 34
	/* battery average temp */
	#define E903009000_BATTERYAVGTEMP_TINYINT 35
	/* charging current when vbat is 3.4V, in mA */
	#define E903009000_MONITORIBAT_0_SMALLINT 36
	/* charging current when vbat is 3.6V, in mA */
	#define E903009000_MONITORIBAT_1_SMALLINT 37
	/* charging current when vbat is 3.8V, in mA */
	#define E903009000_MONITORIBAT_2_SMALLINT 38
	/* charging current when vbat is 3.9V, in mA */
	#define E903009000_MONITORIBAT_3_SMALLINT 39
	/* charging current when vbat is 4.0V, in mA */
	#define E903009000_MONITORIBAT_4_SMALLINT 40
	/* charging current when vbat is 4.1V, in mA */
	#define E903009000_MONITORIBAT_5_SMALLINT 41
	/* charging current when vbat is 4.2V, in mA */
	#define E903009000_MONITORIBAT_6_SMALLINT 42
	/* charging current when vbat is 4.3V, in mA */
	#define E903009000_MONITORIBAT_7_SMALLINT 43
	/* charging current when vbat is 4.4V, in mA */
	#define E903009000_MONITORIBAT_8_SMALLINT 44
	/* battery temp when vbat is 3.4V, in mA */
	#define E903009000_MONITORBATTEMP_0_TINYINT 45
	/* battery temp when vbat is 3.6V, in mA */
	#define E903009000_MONITORBATTEMP_1_TINYINT 46
	/* battery temp when vbat is 3.8V, in mA */
	#define E903009000_MONITORBATTEMP_2_TINYINT 47
	/* battery temp when vbat is 3.9V, in mA */
	#define E903009000_MONITORBATTEMP_3_TINYINT 48
	/* battery temp when vbat is 4.0V, in mA */
	#define E903009000_MONITORBATTEMP_4_TINYINT 49
	/* battery temp when vbat is 4.1V, in mA */
	#define E903009000_MONITORBATTEMP_5_TINYINT 50
	/* battery temp when vbat is 4.2V, in mA */
	#define E903009000_MONITORBATTEMP_6_TINYINT 51
	/* battery temp when vbat is 4.3V, in mA */
	#define E903009000_MONITORBATTEMP_7_TINYINT 52
	/* battery temp when vbat is 4.4V, in mA */
	#define E903009000_MONITORBATTEMP_8_TINYINT 53
	/* charging time for 0%~10% */
	#define E903009000_CHARGINGTIMESTATISTIC_0_SMALLINT 54
	/* charging time for 10%~20% */
	#define E903009000_CHARGINGTIMESTATISTIC_1_SMALLINT 55
	/* charging time for 20%~30% */
	#define E903009000_CHARGINGTIMESTATISTIC_2_SMALLINT 56
	/* charging time for 30%~40% */
	#define E903009000_CHARGINGTIMESTATISTIC_3_SMALLINT 57
	/* charging time for 40%~50% */
	#define E903009000_CHARGINGTIMESTATISTIC_4_SMALLINT 58
	/* charging time for 50%~60% */
	#define E903009000_CHARGINGTIMESTATISTIC_5_SMALLINT 59
	/* charging time for 60%~70% */
	#define E903009000_CHARGINGTIMESTATISTIC_6_SMALLINT 60
	/* charging time for 70%~80% */
	#define E903009000_CHARGINGTIMESTATISTIC_7_SMALLINT 61
	/* charging time for 80%~90% */
	#define E903009000_CHARGINGTIMESTATISTIC_8_SMALLINT 62
	/* charging time for 90%~100% */
	#define E903009000_CHARGINGTIMESTATISTIC_9_SMALLINT 63
...
/*** DMD events' keys ***/
	...
	/* Event 926011001
		TP THREAD CREATION FAILED */
	/* error level */
	#define E926011001_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011001_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011001_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011001_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011001_COUNT_INT 4

	/* Event 926011002
		AFE HAL OPEN FAILED */
	/* error level */
	#define E926011002_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011002_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011002_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011002_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011002_COUNT_INT 4

	/* Event 926011003
		AFE HAL GET INFO FAILED */
	/* error level */
	#define E926011003_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011003_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011003_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011003_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011003_COUNT_INT 4

	/* Event 926011004
		AFE HAL GET HARDWARE INFO ERROR */
	/* error level */
	#define E926011004_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011004_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011004_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011004_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011004_COUNT_INT 4

	/* Event 926011005
		AFE HAL ALLOCATE STATE CHECK ERROR */
	/* error level */
	#define E926011005_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011005_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011005_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011005_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011005_COUNT_INT 4

	/* Event 926011006
		AFE HAL GET OPER POINT VALUE ERROR */
	/* error level */
	#define E926011006_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011006_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011006_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011006_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011006_COUNT_INT 4

	/* Event 926011007
		AFE HAL ALLOCATE MEMORY ERROR */
	/* error level */
	#define E926011007_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011007_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011007_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011007_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011007_COUNT_INT 4

	/* Event 926011008
		AFE HAL GET FRAME ERROR */
	/* error level */
	#define E926011008_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011008_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011008_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011008_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011008_COUNT_INT 4

	/* Event 926011009
		AFE HAL GET PARAM ERROR */
	/* error level */
	#define E926011009_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011009_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011009_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011009_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011009_COUNT_INT 4

	/* Event 926011010
		AFE HAL SET PARAM ERROR */
	/* error level */
	#define E926011010_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011010_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011010_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011010_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011010_COUNT_INT 4

	/* Event 926011011
		AFE HAL UPDATE PARAM ERROR */
	/* error level */
	#define E926011011_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011011_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011011_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011011_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011011_COUNT_INT 4

	/* Event 926011012
		AFE HAL FREQ SHIFT ERROR */
	/* error level */
	#define E926011012_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011012_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011012_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011012_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011012_COUNT_INT 4

	/* Event 926011013
		AFE HAL SUSPEND ERROR */
	/* error level */
	#define E926011013_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011013_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011013_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011013_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011013_COUNT_INT 4

	/* Event 926011014
		AFE HAL RESUME ERROR */
	/* error level */
	#define E926011014_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011014_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011014_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011014_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011014_COUNT_INT 4

	/* Event 926011015
		AFE HAL RESET ERROR */
	/* error level */
	#define E926011015_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011015_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011015_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011015_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011015_COUNT_INT 4

	/* Event 926011016
		AFE HAL RECOVER EIO ERROR */
	/* error level */
	#define E926011016_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011016_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011016_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011016_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011016_COUNT_INT 4

	/* Event 926011017
		AFE HAL INIT ERROR */
	/* error level */
	#define E926011017_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011017_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011017_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011017_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011017_COUNT_INT 4

	/* Event 926011018
		AFE HAL STATUS INIT AFE PARAM ERROR */
	/* error level */
	#define E926011018_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011018_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011018_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011018_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011018_COUNT_INT 4

	/* Event 926011019
		APTOUCH_DAEMON SOCKET COMMUNICATE ERROR */
	/* error level */
	#define E926011019_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011019_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011019_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011019_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011019_COUNT_INT 4

	/* Event 926011020
		APTOUCH_DAEMON OPEN DEV ERROR */
	/* error level */
	#define E926011020_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011020_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011020_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011020_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011020_COUNT_INT 4

	/* Event 926011021
		SPI Read and Write Error */
	/* error level */
	#define E926011021_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011021_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011021_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011021_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011021_COUNT_INT 4

	/* Event 926011022
		DEV STATUSERROR */
	/* error level */
	#define E926011022_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926011022_IC_NAME_VARCHAR 1
	/* module name */
	#define E926011022_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926011022_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926011022_COUNT_INT 4
...
/*** Application events' keys ***/
	...
	/* Event 907034001
		Unlock by right password fail */
	/* error type */
	#define E907034001_ERRORTYPE_INT 0
	/* reason of error */
	#define E907034001_REASON_VARCHAR 1
...
/*** Fingerprint events' keys ***/
	...
	/* sensorhub anti touch count */
	#define E912000000_HUB_ANTI_CNT_INT 24
	/* sensorhub fail image count */
	#define E912000000_HUB_FAIL_CNT_INT 25
	/* sensorhub anti touch score */
	#define E912000000_HUB_SC_INT 26
	/* subarea zones */
	#define E912000000_ZONES_INT 27
	/* effective picture area */
	#define E912000000_E_COV_INT 28
	/* phone temperature */
	#define E912000000_TEMP_INT 29
	...
	/* sensorhub anti touch count */
	#define E912000001_HUB_ANTI_CNT_INT 24
	/* sensorhub fail image count */
	#define E912000001_HUB_FAIL_CNT_INT 25
	/* sensorhub anti touch score */
	#define E912000001_HUB_SC_INT 26
	/* subarea zones */
	#define E912000001_ZONES_INT 27
	/* effective picture area */
	#define E912000001_E_COV_INT 28
	/* phone temperature */
	#define E912000001_TEMP_INT 29
	...
	/* effective picture count */
	#define E912000002_E_DW_CNT_INT 13
	/* subarea zones */
	#define E912000002_ZONES_INT 14
	/* effective picture area */
	#define E912000002_E_COV_INT 15
	/* enroll alg result */
	#define E912000002_ALG_RS_INT 16
	/* phone temperature */
	#define E912000002_TEMP_INT 17
	...
	/* template update times */
	#define E912000003_TPL_UP_T_INT 19
	/* deadpixels count */
	#define E912000003_DPL_CNT_INT 20
	/* gray level histogram */
	#define E912000003_G_H_WTH_INT 21
	/* noise pattern */
	#define E912000003_N_PAT_INT 22

	/* Event 912000004
		FingerPrint touch gestures */
	/* FingerPrintEventID */
	#define E912000004_FPEVENT_INT 0
	/* FingerprintDownTime */
	#define E912000004_FPDOW_T_VARCHAR 1
	/* EventSendTime */
	#define E912000004_SND_T_INT 2
	/* FingerprintUpTime */
	#define E912000004_FPUP_T_INT 3
	/* FP_nav_para_distance */
	#define E912000004_FP_DIS_INT 4
	/* FP_nav_para_frame */
	#define E912000004_FP_FRAM_INT 5
	/* FP_nav_para_s_position */
	#define E912000004_FP_START_P_INT 6
	/* FP_nav_para_r_position */
	#define E912000004_FP_REPORT_P_INT 7
	/* FP_nav_para_e_position */
	#define E912000004_FP_END_P_INT 8
	/* FP_nav_para_mode */
	#define E912000004_FP_MODE_INT 9
	/* FP_nav_para_L_distance */
	#define E912000004_FP_H_D_INT 10
	/* FP_nav_para_U_distance */
	#define E912000004_FP_V_D_INT 11
	/* vendor information */
	#define E912000004_SEN_INF_VARCHAR 12

	/* Event 912000005
		FingerPrint touch statistics */
	/* ClickCount */
	#define E912000005_C_CNT_INT 0
	/* ClickAverageTime */
	#define E912000005_C_AVG_T_INT 1
	/* LeftAverageDistance */
	#define E912000005_C_AVG_D_INT 2
	/* LongPressCount */
	#define E912000005_L_P_CNT_INT 3
	/* LongPressAverageTime */
	#define E912000005_L_P_AVG_T_INT 4
	/* LeftAverageDistance */
	#define E912000005_L_P_AVG_D_INT 5
	/* LeftCount */
	#define E912000005_L_CNT_INT 6
	/* LeftAverageTime */
	#define E912000005_L_AVG_T_INT 7
	/* LeftAverageDistance */
	#define E912000005_L_AVG_D_INT 8
	/* RightCount */
	#define E912000005_R_CNT_INT 9
	/* RightAverageTime */
	#define E912000005_R_AVG_T_INT 10
	/* RightAverageDistance */
	#define E912000005_R_AVG_D_INT 11
	/* vendor information */
	#define E912000005_SEN_INF_VARCHAR 12
...
/*** Storage events' keys ***/
	...
	/* Event 914005000
		the info for 1861 ufs device */
	/* nand total read data */
	#define E914005000_NAND_TOTAL_READ_INT 0
	/* nand total write data */
	#define E914005000_NAND_TOTAL_WRITE_INT 1
	/* free block of A space */
	#define E914005000_SPACE_BLOCK_LEFT_A_INT 2
	/* free block of B space */
	#define E914005000_SPACE_BLOCK_LEFT_B_INT 3
	/* GC stop line one */
	#define E914005000_GC_STOP_LINE_1_INT 4
	/* GC stop line two */
	#define E914005000_GC_STOP_LINE_2_INT 5
	/* GC stop line three */
	#define E914005000_GC_STOP_LINE_3_INT 6
	/* ratio of write gc */
	#define E914005000_RATIO_WRITE_GC_INT 7
	/* spor number */
	#define E914005000_SPOT_NUM_INT 8
	/* weak program number */
	#define E914005000_WEAK_PRO_NUM_INT 9
	/* read all one number */
	#define E914005000_READ_ALL_ONE_NUM_INT 10
	/* read unc number */
	#define E914005000_READ_UNC_NUM_INT 11
	/* write fail number */
	#define E914005000_WRITE_FAIL_NUM_INT 12
	/* erase fail number */
	#define E914005000_ERASE_FAIL_NUM_INT 13
	/* temprature fail number */
	#define E914005000_TEMPRTURE_FAIL_NUM_INT 14
	/* ufs exception number */
	#define E914005000_UFS_FAIL_NUM_INT 15
	/* gc unc number */
	#define E914005000_GC_UNC_NUM_INT 16

	/* Event 914006000
		the vendor info for ufs device */
	/* total host read data */
	#define E914006000_HOST_TOTAL_READ_INT 0
	/* total host write data */
	#define E914006000_HOST_TOTAL_WRITE_INT 1
	/* min ec number of A space */
	#define E914006000_MIN_EC_NUM_A_INT 2
	/* max ec number of A space */
	#define E914006000_MAX_EC_NUM_A_INT 3
	/* ave ec number of A space */
	#define E914006000_AVE_EC_NUM_A_INT 4
	/* min ec number of B space */
	#define E914006000_MIN_EC_NUM_B_INT 5
	/* max ec number of B space */
	#define E914006000_MAX_EC_NUM_B_INT 6
	/* ave ec number of B space */
	#define E914006000_AVE_EC_NUM_B_INT 7
	/* ave ec number of enhance space */
	#define E914006000_AVE_EC_NUM_ENHANCE_INT 8
	/* original bad block number */
	#define E914006000_ORIGIN_BAD_BLOCK_NUM_INT 9
	/* run bad block number */
	...
	/* Number of failures recover new host data after Power
		Loss */
	#define E914006000_SPOR_WRITE_FAIL_NUM_INT 14
	/* Total Recovery Operations After Voltage Droop */
	...
	/* writeamplification of device */
	#define E914006000_WRITE_AMPLIFICATION_SMALLINT 28

	/* Event 914007000
		the criteria info for ufs device */
	/* all left space */
	...
	/* Event 914010000
		sdcard info */
	/* sd card vendor id of device */
	#define E914010000_SD_VENDOR_ID_INT 0
	/* sd card rate */
	#define E914010000_SD_RATE_INT 1
	/* sd card max rate */
	#define E914010000_SD_MAX_RATE_INT 2
	/* sd card encrypt */
	#define E914010000_SD_ENCRYPT_SMALLINT 3
	/* sd card lock */
	#define E914010000_SD_LOCK_SMALLINT 4
	/* sd card primiay */
	#define E914010000_SD_PRIMIAY_CARD_SMALLINT 5
	/* sd card read onley */
	#define E914010000_SD_READ_ONLY_SMALLINT 6
	/* sd card capacity */
	#define E914010000_SD_CAPACITY_INT 7
	/* sd card free space */
	#define E914010000_SD_FREE_SPACE_INT 8
	/* sd card total read data */
	#define E914010000_SD_TOTAL_READ_INT 9
	/* sd card total write data */
	#define E914010000_SD_TOTAL_WRITE_INT 10
	/* sd card read bandith */
	#define E914010000_SD_READ_BANDITH_INT 11
	/* sd card write bandith */
	#define E914010000_SD_WRITE_BANDITH_INT 12
	/* sd card read retry number */
	#define E914010000_SD_READ_RETRY_NUM_INT 13
	/* sd card write retry number */
	#define E914010000_SD_WRITE_RETRY_NUM_INT 14
...
/*** Audio events' keys ***/
	...
	#define E916010101_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010101_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010101_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010101_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010101_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010101_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010101_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010101_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010101_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010101_RESERVED2_VARCHAR 9

	/* Event 916010102
		Extractor Error */
	/* Event Level(mandatory) */
	#define E916010102_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010102_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010102_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010102_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010102_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010102_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010102_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010102_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010102_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010102_RESERVED2_VARCHAR 9

	/* Event 916010103
		Decoder Error */
	/* Event Level(mandatory) */
	#define E916010103_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010103_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010103_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010103_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010103_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010103_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010103_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010103_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010103_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010103_RESERVED2_VARCHAR 9

	/* Event 916010104
		Render Error */
	/* Event Level(mandatory) */
	#define E916010104_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010104_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010104_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010104_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010104_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010104_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010104_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010104_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010104_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010104_RESERVED2_VARCHAR 9

	/* Event 916010105
		Streaming Error */
	/* Event Level(mandatory) */
	#define E916010105_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010105_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010105_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010105_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010105_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010105_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010105_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010105_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010105_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010105_RESERVED2_VARCHAR 9

	/* Event 916010106
		MediaPlayer Service Error */
	/* Event Level(mandatory) */
	#define E916010106_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010106_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010106_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010106_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010106_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010106_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010106_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010106_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010106_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010106_RESERVED2_VARCHAR 9

	/* Event 916010201
		Mode Error */
	/* Event Level(mandatory) */
	#define E916010201_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010201_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010201_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010201_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010201_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010201_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010201_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010201_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010201_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010201_RESERVED2_VARCHAR 9

	/* Event 916010202
		RingTone Error */
	/* Event Level(mandatory) */
	#define E916010202_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010202_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010202_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010202_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010202_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010202_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010202_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010202_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010202_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010202_RESERVED2_VARCHAR 9

	/* Event 916010203
		Mic Error */
	/* Event Level(mandatory) */
	#define E916010203_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010203_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010203_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010203_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010203_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010203_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010203_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010203_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010203_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010203_RESERVED2_VARCHAR 9

	/* Event 916010204
		BlueTooth SCO Error */
	/* Event Level(mandatory) */
	#define E916010204_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010204_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010204_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010204_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010204_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010204_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010204_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010204_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010204_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010204_RESERVED2_VARCHAR 9

	/* Event 916010205
		Volume Error */
	/* Event Level(mandatory) */
	#define E916010205_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010205_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010205_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010205_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010205_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010205_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010205_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010205_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010205_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010205_RESERVED2_VARCHAR 9

	/* Event 916010206
		Video No Signal */
	/* Event Level(mandatory) */
	#define E916010206_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010206_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010206_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010206_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010206_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010206_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010206_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010206_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010206_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010206_RESERVED2_VARCHAR 9

	/* Event 916010207
		Track Full Error */
	/* Event Level(mandatory) */
	#define E916010207_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010207_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010207_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010207_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010207_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010207_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010207_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010207_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010207_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010207_RESERVED2_VARCHAR 9

	/* Event 916010301
		Create Track Error */
	/* Event Level(mandatory) */
	#define E916010301_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010301_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010301_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010301_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010301_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010301_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010301_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010301_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010301_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010301_RESERVED2_VARCHAR 9

	/* Event 916010302
		Record Track Error */
	/* Event Level(mandatory) */
	#define E916010302_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010302_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010302_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010302_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010302_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010302_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010302_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010302_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010302_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010302_RESERVED2_VARCHAR 9

	/* Event 916010303
		Mix Error */
	/* Event Level(mandatory) */
	#define E916010303_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010303_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010303_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010303_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010303_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010303_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010303_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010303_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010303_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010303_RESERVED2_VARCHAR 9

	/* Event 916010401
		AudioEffect */
	/* Event Level(mandatory) */
	#define E916010401_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010401_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010401_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010401_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010401_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010401_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010401_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010401_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010401_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010401_RESERVED2_VARCHAR 9

	/* Event 916010501
		AF Audio Latency Error */
	/* Event Level(mandatory) */
	#define E916010501_EEVENTLEVEL_INT 0
	/* Sub Type(mandatory) */
	#define E916010501_SUBTYPE_INT 1
	/* User Scenario description(mandatory or null) */
	#define E916010501_REASON_VARCHAR 2
	/* Calling Applcation Name */
	#define E916010501_CALLINGAPP_VARCHAR 3
	/* Error Count(only when level and subtype match) */
	#define E916010501_COUNT_INT 4
	/* paramter Int(Specified by Scenario ) */
	#define E916010501_PARAINT_INT 5
	/* paramter Char(Specified by Scenario ) */
	#define E916010501_PARACHAR_VARCHAR 6
	/* Associated Eevent ID */
	#define E916010501_ASSOCIATEDEEVENTID_INT 7
	/* Reserverd Parameter 1 */
	#define E916010501_RESERVED1_INT 8
	/* Reserverd Parameter 2 */
	#define E916010501_RESERVED2_VARCHAR 9
...
/*** Ecom events' keys ***/
	...
	/* Event 919000000
		Web Browser Experience Normal Log */
	/* BROWSER_APP_Name */
	#define E919000000_BROWSER_APP_NAME_VARCHAR 0
	/* LATANCY_ALL_PAGE */
	#define E919000000_LATANCY_ALL_PAGE_SMALLINT 1
	/* PAGE_SUCCEED_FLAG */
	#define E919000000_PAGE_SUCCEED_FLAG_TINYINT 2
	/* TIME_ZONE */
	#define E919000000_TIME_ZONE_SMALLINT 3
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000000_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 4
	/* SESSION_START_DATE */
	#define E919000000_SESSION_START_DATE_INT 5
	/* SESSION_START_TIME */
	#define E919000000_SESSION_START_TIME_INT 6
	/* SESSION_END_TIME */
	#define E919000000_SESSION_END_TIME_INT 7
	/* HOST_NAME */
	#define E919000000_HOST_NAME_VARCHAR 8
	/* URL */
	#define E919000000_URL_VARCHAR 9
	/* L7_UL_TRAFFIC */
	#define E919000000_L7_UL_TRAFFIC_INT 10
	/* L7_DL_TRAFFIC */
	#define E919000000_L7_DL_TRAFFIC_INT 11
	/* DATATRANS_UL_DURATION */
	#define E919000000_DATATRANS_UL_DURATION_INT 12
	/* DATATRANS_DL_DURATION */
	#define E919000000_DATATRANS_DL_DURATION_INT 13
	/* MCC */
	#define E919000000_MCC_SMALLINT 14
	/* MNC */
	#define E919000000_MNC_SMALLINT 15
	/* RAT */
	#define E919000000_RAT_TINYINT 16
	/* TIME_CELL_ID */
	#define E919000000_CELL_ID_VARCHAR 17
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000000_LOCATION_INT 18
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000000_EUTRAN_NEIGHBOR_VARCHAR 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000000_UTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000000_WLAN_VARCHAR 21
	/* DL_RSRP */
	#define E919000000_DL_RSRP_TINYINT 22
	/* DL_RSRQ */
	#define E919000000_DL_RSRQ_TINYINT 23
	/* DL_SINR */
	#define E919000000_DL_SINR_INT 24
	/* DL_BLER */
	#define E919000000_DL_BLER_SMALLINT 25

	/* Event 919000001
		Web Browser Experience Abnormal Log */
	/* BROWSER_APP_Name */
	#define E919000001_BROWSER_APP_NAME_VARCHAR 0
	/* LATANCY_ALL_PAGE */
	#define E919000001_LATANCY_ALL_PAGE_SMALLINT 1
	/* PAGE_SUCCEED_FLAG */
	#define E919000001_PAGE_SUCCEED_FLAG_TINYINT 2
	/* TIME_ZONE */
	#define E919000001_TIME_ZONE_SMALLINT 3
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000001_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 4
	/* SESSION_START_DATE */
	#define E919000001_SESSION_START_DATE_INT 5
	/* SESSION_START_TIME */
	#define E919000001_SESSION_START_TIME_INT 6
	/* SESSION_END_TIME */
	#define E919000001_SESSION_END_TIME_INT 7
	/* HOST_NAME */
	#define E919000001_HOST_NAME_SMALLINT 8
	/* URL */
	#define E919000001_URL_VARCHAR 9
	/* L7_UL_TRAFFIC */
	#define E919000001_L7_UL_TRAFFIC_INT 10
	/* L7_DL_TRAFFIC */
	#define E919000001_L7_DL_TRAFFIC_INT 11
	/* DATATRANS_UL_DURATION */
	#define E919000001_DATATRANS_UL_DURATION_INT 12
	/* DATATRANS_DL_DURATION */
	#define E919000001_DATATRANS_DL_DURATION_INT 13
	/* MCC */
	#define E919000001_MCC_SMALLINT 14
	/* MNC */
	#define E919000001_MNC_SMALLINT 15
	/* RAT */
	#define E919000001_RAT_TINYINT 16
	/* TIME_CELL_ID */
	#define E919000001_CELL_ID_VARCHAR 17
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000001_LOCATION_INT 18
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000001_EUTRAN_NEIGHBOR_VARCHAR 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000001_UTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000001_WLAN_VARCHAR 21
	/* DNS_DELAY */
	#define E919000001_DNS_DELAY_SMALLINT 22
	/* DNS_SUCCEED_FLAG */
	#define E919000001_DNS_SUCCEED_FLAG_TINYINT 23
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000001_TCP_SYN_SUCCEED_FLAG_TINYINT 24
	/* TCP_SYN_TIME */
	#define E919000001_TCP_SYN_TIME_INT 25
	/* TCP_RTT_STEP2 */
	#define E919000001_TCP_RTT_STEP2_INT 26
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000001_MS_ACK_TO_1STGET_DELAY_SMALLINT 27
	/* GET_TO_1STDATA_DELAY */
	#define E919000001_GET_TO_1STDATA_DELAY_SMALLINT 28
	/* FIRST_RESPONSE_CODE */
	#define E919000001_FIRST_RESPONSE_CODE_SMALLINT 29
	/* FIR_FAIL_TIME */
	#define E919000001_FIR_FAIL_TIME_INT 30
	/* TCP_WIN_SIZE */
	#define E919000001_TCP_WIN_SIZE_INT 31
	/* TCP_WIN_ZERO_COUNT */
	#define E919000001_TCP_WIN_ZERO_COUNT_SMALLINT 32
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000001_MS_WIN_STAT_TOTAL_NUM_INT 33
	/* TCP_MSS */
	#define E919000001_TCP_MSS_SMALLINT 34
	/* TCP_UL_PACKAGES */
	#define E919000001_TCP_UL_PACKAGES_INT 35
	/* TCP_DL_PACKAGES */
	#define E919000001_TCP_DL_PACKAGES_INT 36
	/* TCP_UL_RETRANS */
	#define E919000001_TCP_UL_RETRANS_INT 37
	/* TCP_DL_RETRANS */
	#define E919000001_TCP_DL_RETRANS_INT 38
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000001_TCP_UL_TIMEOUT_RETRANS_SMALLINT 39
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000001_TCP_DL_TIMEOUT_RETRANS_SMALLINT 40
	/* TCP_UL_FAST RETRANS */
	#define E919000001_TCP_UL_FAST_RETRANS_SMALLINT 41
	/* TCP_DL_FAST RETRANS */
	#define E919000001_TCP_DL_FAST_RETRANS_SMALLINT 42
	/* TCP_UL_OUTOFSEQU */
	#define E919000001_TCP_UL_OUTOFSEQU_SMALLINT 43
	/* TCP_DL_OUTOFSEQU */
	#define E919000001_TCP_DL_OUTOFSEQU_SMALLINT 44
	/* UL_RTT */
	#define E919000001_UL_RTT_SMALLINT 45
	/* RECEIVE_RTT */
	#define E919000001_RECEIVE_RTT_SMALLINT 46
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000001_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 47
	/* DL_RSRP */
	#define E919000001_DL_RSRP_TINYINT 48
	/* DL_RSRQ */
	#define E919000001_DL_RSRQ_TINYINT 49
	/* DL_SINR */
	#define E919000001_DL_SINR_INT 50
	/* DL_BLER */
	#define E919000001_DL_BLER_SMALLINT 51
	/* Reliability */
	#define E919000001_RELIABILITY_INT 52
	/* Performance */
	#define E919000001_PERFORMANCE_INT 53
	/* CHR */
	#define E919000001_CHR_INT 54

	/* Event 919000002
		WeChat Red envelopes Experience Normal Log */
	/* LATANCY_SEND */
	#define E919000002_LATANCY_SEND_SMALLINT 0
	/* SEND_SUCCEED_FLAG */
	#define E919000002_SEND_SUCCEED_FLAG_TINYINT 1
	/* RECEIVE_SUCCEED_FLAG */
	#define E919000002_RECEIVE_SUCCEED_FLAG_TINYINT 2
	/* LATANCY_RECEIVE */
	#define E919000002_LATANCY_RECEIVE_SMALLINT 3
	/* LATANCY_GRAB */
	#define E919000002_LATANCY_GRAB_SMALLINT 4
	/* LATANCY_OPEN */
	#define E919000002_LATANCY_OPEN_SMALLINT 5
	/* TIME_ZONE */
	#define E919000002_TIME_ZONE_SMALLINT 6
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000002_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 7
	/* SESSION_START_DATE */
	#define E919000002_SESSION_START_DATE_INT 8
	/* SESSION_START_TIME */
	#define E919000002_SESSION_START_TIME_INT 9
	/* SESSION_END_TIME */
	#define E919000002_SESSION_END_TIME_INT 10
	/* HOST_NAME */
	#define E919000002_HOST_NAME_SMALLINT 11
	/* URL */
	#define E919000002_URL_VARCHAR 12
	/* L7_UL_TRAFFIC */
	#define E919000002_L7_UL_TRAFFIC_INT 13
	/* L7_DL_TRAFFIC */
	#define E919000002_L7_DL_TRAFFIC_INT 14
	/* DATATRANS_UL_DURATION */
	#define E919000002_DATATRANS_UL_DURATION_INT 15
	/* DATATRANS_DL_DURATION */
	#define E919000002_DATATRANS_DL_DURATION_INT 16
	/* MCC */
	#define E919000002_MCC_SMALLINT 17
	/* MNC */
	#define E919000002_MNC_SMALLINT 18
	/* RAT */
	#define E919000002_RAT_TINYINT 19
	/* TIME_CELL_ID */
	#define E919000002_CELL_ID_VARCHAR 20
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000002_LOCATION_INT 21
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000002_EUTRAN_NEIGHBOR_VARCHAR 22
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000002_UTRAN_NEIGHBOR_VARCHAR 23
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000002_WLAN_VARCHAR 24
	/* DL_RSRP */
	#define E919000002_DL_RSRP_TINYINT 25
	/* DL_RSRQ */
	#define E919000002_DL_RSRQ_TINYINT 26
	/* DL_SINR */
	#define E919000002_DL_SINR_INT 27
	/* DL_BLER */
	#define E919000002_DL_BLER_SMALLINT 28

	/* Event 919000003
		WeChat Red envelopes Experience Abnormal Log */
	/* LATANCY_SEND */
	#define E919000003_LATANCY_SEND_SMALLINT 0
	/* SEND_SUCCEED_FLAG */
	#define E919000003_SEND_SUCCEED_FLAG_TINYINT 1
	/* RECEIVE_SUCCEED_FLAG */
	#define E919000003_RECEIVE_SUCCEED_FLAG_TINYINT 2
	/* LATANCY_RECEIVE */
	#define E919000003_LATANCY_RECEIVE_SMALLINT 3
	/* LATANCY_GRAB */
	#define E919000003_LATANCY_GRAB_SMALLINT 4
	/* LATANCY_OPEN */
	#define E919000003_LATANCY_OPEN_SMALLINT 5
	/* TIME_ZONE */
	#define E919000003_TIME_ZONE_SMALLINT 6
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000003_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 7
	/* SESSION_START_DATE */
	#define E919000003_SESSION_START_DATE_INT 8
	/* SESSION_START_TIME */
	#define E919000003_SESSION_START_TIME_INT 9
	/* SESSION_END_TIME */
	#define E919000003_SESSION_END_TIME_INT 10
	/* HOST_NAME */
	#define E919000003_HOST_NAME_SMALLINT 11
	/* URL */
	#define E919000003_URL_VARCHAR 12
	/* L7_UL_TRAFFIC */
	#define E919000003_L7_UL_TRAFFIC_INT 13
	/* L7_DL_TRAFFIC */
	#define E919000003_L7_DL_TRAFFIC_INT 14
	/* DATATRANS_UL_DURATION */
	#define E919000003_DATATRANS_UL_DURATION_INT 15
	/* DATATRANS_DL_DURATION */
	#define E919000003_DATATRANS_DL_DURATION_INT 16
	/* MCC */
	#define E919000003_MCC_SMALLINT 17
	/* MNC */
	#define E919000003_MNC_SMALLINT 18
	/* RAT */
	#define E919000003_RAT_TINYINT 19
	/* TIME_CELL_ID */
	#define E919000003_CELL_ID_VARCHAR 20
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000003_LOCATION_INT 21
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000003_EUTRAN_NEIGHBOR_VARCHAR 22
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000003_UTRAN_NEIGHBOR_VARCHAR 23
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000003_WLAN_VARCHAR 24
	/* DNS_DELAY */
	#define E919000003_DNS_DELAY_SMALLINT 25
	/* DNS_SUCCEED_FLAG */
	#define E919000003_DNS_SUCCEED_FLAG_TINYINT 26
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000003_TCP_SYN_SUCCEED_FLAG_TINYINT 27
	/* TCP_SYN_TIME */
	#define E919000003_TCP_SYN_TIME_INT 28
	/* TCP_RTT_STEP2 */
	#define E919000003_TCP_RTT_STEP2_INT 29
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000003_MS_ACK_TO_1STGET_DELAY_SMALLINT 30
	/* GET_TO_1STDATA_DELAY */
	#define E919000003_GET_TO_1STDATA_DELAY_SMALLINT 31
	/* FIRST_RESPONSE_CODE */
	#define E919000003_FIRST_RESPONSE_CODE_SMALLINT 32
	/* FIR_FAIL_TIME */
	#define E919000003_FIR_FAIL_TIME_INT 33
	/* TCP_WIN_SIZE */
	#define E919000003_TCP_WIN_SIZE_INT 34
	/* TCP_WIN_ZERO_COUNT */
	#define E919000003_TCP_WIN_ZERO_COUNT_SMALLINT 35
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000003_MS_WIN_STAT_TOTAL_NUM_INT 36
	/* TCP_MSS */
	#define E919000003_TCP_MSS_SMALLINT 37
	/* TCP_UL_PACKAGES */
	#define E919000003_TCP_UL_PACKAGES_INT 38
	/* TCP_DL_PACKAGES */
	#define E919000003_TCP_DL_PACKAGES_INT 39
	/* TCP_UL_RETRANS */
	#define E919000003_TCP_UL_RETRANS_INT 40
	/* TCP_DL_RETRANS */
	#define E919000003_TCP_DL_RETRANS_INT 41
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000003_TCP_UL_TIMEOUT_RETRANS_SMALLINT 42
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000003_TCP_DL_TIMEOUT_RETRANS_SMALLINT 43
	/* TCP_UL_FAST RETRANS */
	#define E919000003_TCP_UL_FAST_RETRANS_SMALLINT 44
	/* TCP_DL_FAST RETRANS */
	#define E919000003_TCP_DL_FAST_RETRANS_SMALLINT 45
	/* TCP_UL_OUTOFSEQU */
	#define E919000003_TCP_UL_OUTOFSEQU_SMALLINT 46
	/* TCP_DL_OUTOFSEQU */
	#define E919000003_TCP_DL_OUTOFSEQU_SMALLINT 47
	/* UL_RTT */
	#define E919000003_UL_RTT_SMALLINT 48
	/* RECEIVE_RTT */
	#define E919000003_RECEIVE_RTT_SMALLINT 49
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000003_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 50
	/* DL_RSRP */
	#define E919000003_DL_RSRP_TINYINT 51
	/* DL_RSRQ */
	#define E919000003_DL_RSRQ_TINYINT 52
	/* DL_SINR */
	#define E919000003_DL_SINR_INT 53
	/* DL_BLER */
	#define E919000003_DL_BLER_SMALLINT 54
	/* Reliability */
	#define E919000003_RELIABILITY_INT 55
	/* Performance */
	#define E919000003_PERFORMANCE_INT 56
	/* CHR */
	#define E919000003_CHR_INT 57

	/* Event 919000004
		Email Experience Normal Log */
	/* Email_APP_NAME */
	#define E919000004_EMAIL_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000004_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000004_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000004_SUCCEED_FLAG_TINYINT 3
	/* ABNORMAL_DROPPING_FLAG */
	#define E919000004_ABNORMAL_DROPPING_FLAG_TINYINT 4
	/* TIME_ZONE */
	#define E919000004_TIME_ZONE_SMALLINT 5
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000004_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 6
	/* SESSION_START_DATE */
	#define E919000004_SESSION_START_DATE_INT 7
	/* SESSION_START_TIME */
	#define E919000004_SESSION_START_TIME_INT 8
	/* SESSION_END_TIME */
	#define E919000004_SESSION_END_TIME_INT 9
	/* HOST_NAME */
	#define E919000004_HOST_NAME_SMALLINT 10
	/* URL */
	#define E919000004_URL_VARCHAR 11
	/* L7_UL_TRAFFIC */
	#define E919000004_L7_UL_TRAFFIC_INT 12
	/* L7_DL_TRAFFIC */
	#define E919000004_L7_DL_TRAFFIC_INT 13
	/* DATATRANS_UL_DURATION */
	#define E919000004_DATATRANS_UL_DURATION_INT 14
	/* DATATRANS_DL_DURATION */
	#define E919000004_DATATRANS_DL_DURATION_INT 15
	/* MCC */
	#define E919000004_MCC_SMALLINT 16
	/* MNC */
	#define E919000004_MNC_SMALLINT 17
	/* RAT */
	#define E919000004_RAT_TINYINT 18
	/* TIME_CELL_ID */
	#define E919000004_CELL_ID_VARCHAR 19
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000004_LOCATION_INT 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000004_EUTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000004_UTRAN_NEIGHBOR_VARCHAR 22
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000004_WLAN_VARCHAR 23
	/* DL_RSRP */
	#define E919000004_DL_RSRP_TINYINT 24
	/* DL_RSRQ */
	#define E919000004_DL_RSRQ_TINYINT 25
	/* DL_SINR */
	#define E919000004_DL_SINR_INT 26
	/* DL_BLER */
	#define E919000004_DL_BLER_SMALLINT 27

	/* Event 919000005
		Email Experience Abnormal Log */
	/* Email_APP_NAME */
	#define E919000005_EMAIL_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000005_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000005_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000005_SUCCEED_FLAG_TINYINT 3
	/* ABNORMAL_DROPPING_FLAG */
	#define E919000005_ABNORMAL_DROPPING_FLAG_TINYINT 4
	/* TIME_ZONE */
	#define E919000005_TIME_ZONE_SMALLINT 5
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000005_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 6
	/* SESSION_START_DATE */
	#define E919000005_SESSION_START_DATE_INT 7
	/* SESSION_START_TIME */
	#define E919000005_SESSION_START_TIME_INT 8
	/* SESSION_END_TIME */
	#define E919000005_SESSION_END_TIME_INT 9
	/* HOST_NAME */
	#define E919000005_HOST_NAME_SMALLINT 10
	/* URL */
	#define E919000005_URL_VARCHAR 11
	/* L7_UL_TRAFFIC */
	#define E919000005_L7_UL_TRAFFIC_INT 12
	/* L7_DL_TRAFFIC */
	#define E919000005_L7_DL_TRAFFIC_INT 13
	/* DATATRANS_UL_DURATION */
	#define E919000005_DATATRANS_UL_DURATION_INT 14
	/* DATATRANS_DL_DURATION */
	#define E919000005_DATATRANS_DL_DURATION_INT 15
	/* MCC */
	#define E919000005_MCC_SMALLINT 16
	/* MNC */
	#define E919000005_MNC_SMALLINT 17
	/* RAT */
	#define E919000005_RAT_TINYINT 18
	/* TIME_CELL_ID */
	#define E919000005_CELL_ID_VARCHAR 19
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000005_LOCATION_INT 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000005_EUTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000005_UTRAN_NEIGHBOR_VARCHAR 22
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000005_WLAN_VARCHAR 23
	/* DNS_DELAY */
	#define E919000005_DNS_DELAY_SMALLINT 24
	/* DNS_SUCCEED_FLAG */
	#define E919000005_DNS_SUCCEED_FLAG_TINYINT 25
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000005_TCP_SYN_SUCCEED_FLAG_TINYINT 26
	/* TCP_SYN_TIME */
	#define E919000005_TCP_SYN_TIME_INT 27
	/* TCP_RTT_STEP2 */
	#define E919000005_TCP_RTT_STEP2_INT 28
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000005_MS_ACK_TO_1STGET_DELAY_SMALLINT 29
	/* GET_TO_1STDATA_DELAY */
	#define E919000005_GET_TO_1STDATA_DELAY_SMALLINT 30
	/* FIRST_RESPONSE_CODE */
	#define E919000005_FIRST_RESPONSE_CODE_SMALLINT 31
	/* FIR_FAIL_TIME */
	#define E919000005_FIR_FAIL_TIME_INT 32
	/* TCP_WIN_SIZE */
	#define E919000005_TCP_WIN_SIZE_INT 33
	/* TCP_WIN_ZERO_COUNT */
	#define E919000005_TCP_WIN_ZERO_COUNT_SMALLINT 34
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000005_MS_WIN_STAT_TOTAL_NUM_INT 35
	/* TCP_MSS */
	#define E919000005_TCP_MSS_SMALLINT 36
	/* TCP_UL_PACKAGES */
	#define E919000005_TCP_UL_PACKAGES_INT 37
	/* TCP_DL_PACKAGES */
	#define E919000005_TCP_DL_PACKAGES_INT 38
	/* TCP_UL_RETRANS */
	#define E919000005_TCP_UL_RETRANS_INT 39
	/* TCP_DL_RETRANS */
	#define E919000005_TCP_DL_RETRANS_INT 40
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000005_TCP_UL_TIMEOUT_RETRANS_SMALLINT 41
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000005_TCP_DL_TIMEOUT_RETRANS_SMALLINT 42
	/* TCP_UL_FAST RETRANS */
	#define E919000005_TCP_UL_FAST_RETRANS_SMALLINT 43
	/* TCP_DL_FAST RETRANS */
	#define E919000005_TCP_DL_FAST_RETRANS_SMALLINT 44
	/* TCP_UL_OUTOFSEQU */
	#define E919000005_TCP_UL_OUTOFSEQU_SMALLINT 45
	/* TCP_DL_OUTOFSEQU */
	#define E919000005_TCP_DL_OUTOFSEQU_SMALLINT 46
	/* UL_RTT */
	#define E919000005_UL_RTT_SMALLINT 47
	/* RECEIVE_RTT */
	#define E919000005_RECEIVE_RTT_SMALLINT 48
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000005_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 49
	/* DL_RSRP */
	#define E919000005_DL_RSRP_TINYINT 50
	/* DL_RSRQ */
	#define E919000005_DL_RSRQ_TINYINT 51
	/* DL_SINR */
	#define E919000005_DL_SINR_INT 52
	/* DL_BLER */
	#define E919000005_DL_BLER_SMALLINT 53
	/* Reliability */
	#define E919000005_RELIABILITY_INT 54
	/* Performance */
	#define E919000005_PERFORMANCE_INT 55
	/* CHR */
	#define E919000005_CHR_INT 56

	/* Event 919000006
		Video Experience Normal Log */
	/* VIDEO_APP_NAME */
	#define E919000006_VIDEO_APP_NAME_VARCHAR 0
	/* VIDEO_SR_DELAY */
	#define E919000006_VIDEO_SR_DELAY_SMALLINT 1
	/* INTBUFFER_FULL_DELAY */
	#define E919000006_INTBUFFER_FULL_DELAY_SMALLINT 2
	/* STALLING_TIMES */
	#define E919000006_STALLING_TIMES_TINYINT 3
	/* STALLING_LENGTH_TOTAL */
	#define E919000006_STALLING_LENGTH_TOTAL_SMALLINT 4
	/* STREAMING_DURATIOIN */
	#define E919000006_STREAMING_DURATIOIN_SMALLINT 5
	/* VIDEO_DATA_RATE */
	#define E919000006_VIDEO_DATA_RATE_INT 6
	/* VIDEO_TERMINATE_FLAG */
	#define E919000006_VIDEO_TERMINATE_FLAG_TINYINT 7
	/* U_VMOS */
	#define E919000006_U_VMOS_TINYINT 8
	/* TIME_ZONE */
	#define E919000006_TIME_ZONE_SMALLINT 9
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000006_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 10
	/* SESSION_START_DATE */
	#define E919000006_SESSION_START_DATE_INT 11
	/* SESSION_START_TIME */
	#define E919000006_SESSION_START_TIME_INT 12
	/* SESSION_END_TIME */
	#define E919000006_SESSION_END_TIME_INT 13
	/* HOST_NAME */
	#define E919000006_HOST_NAME_SMALLINT 14
	/* URL */
	#define E919000006_URL_VARCHAR 15
	/* L7_UL_TRAFFIC */
	#define E919000006_L7_UL_TRAFFIC_INT 16
	/* L7_DL_TRAFFIC */
	#define E919000006_L7_DL_TRAFFIC_INT 17
	/* DATATRANS_UL_DURATION */
	#define E919000006_DATATRANS_UL_DURATION_INT 18
	/* DATATRANS_DL_DURATION */
	#define E919000006_DATATRANS_DL_DURATION_INT 19
	/* MCC */
	#define E919000006_MCC_SMALLINT 20
	/* MNC */
	#define E919000006_MNC_SMALLINT 21
	/* RAT */
	#define E919000006_RAT_TINYINT 22
	/* TIME_CELL_ID */
	#define E919000006_CELL_ID_VARCHAR 23
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000006_LOCATION_INT 24
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000006_EUTRAN_NEIGHBOR_VARCHAR 25
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000006_UTRAN_NEIGHBOR_VARCHAR 26
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000006_WLAN_VARCHAR 27
	/* DL_RSRP */
	#define E919000006_DL_RSRP_TINYINT 28
	/* DL_RSRQ */
	#define E919000006_DL_RSRQ_TINYINT 29
	/* DL_SINR */
	#define E919000006_DL_SINR_INT 30
	/* DL_BLER */
	#define E919000006_DL_BLER_SMALLINT 31

	/* Event 919000007
		Video Experience Abnormal Log */
	/* VIDEO_APP_NAME */
	#define E919000007_VIDEO_APP_NAME_VARCHAR 0
	/* VIDEO_SR_DELAY */
	#define E919000007_VIDEO_SR_DELAY_SMALLINT 1
	/* INTBUFFER_FULL_DELAY */
	#define E919000007_INTBUFFER_FULL_DELAY_SMALLINT 2
	/* STALLING_TIMES */
	#define E919000007_STALLING_TIMES_TINYINT 3
	/* STALLING_LENGTH_TOTAL */
	#define E919000007_STALLING_LENGTH_TOTAL_SMALLINT 4
	/* STREAMING_DURATIOIN */
	#define E919000007_STREAMING_DURATIOIN_SMALLINT 5
	/* VIDEO_DATA_RATE */
	#define E919000007_VIDEO_DATA_RATE_INT 6
	/* VIDEO_TERMINATE_FLAG */
	#define E919000007_VIDEO_TERMINATE_FLAG_TINYINT 7
	/* U_VMOS */
	#define E919000007_U_VMOS_TINYINT 8
	/* TIME_ZONE */
	#define E919000007_TIME_ZONE_SMALLINT 9
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000007_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 10
	/* SESSION_START_DATE */
	#define E919000007_SESSION_START_DATE_INT 11
	/* SESSION_START_TIME */
	#define E919000007_SESSION_START_TIME_INT 12
	/* SESSION_END_TIME */
	#define E919000007_SESSION_END_TIME_INT 13
	/* HOST_NAME */
	#define E919000007_HOST_NAME_SMALLINT 14
	/* URL */
	#define E919000007_URL_VARCHAR 15
	/* L7_UL_TRAFFIC */
	#define E919000007_L7_UL_TRAFFIC_INT 16
	/* L7_DL_TRAFFIC */
	#define E919000007_L7_DL_TRAFFIC_INT 17
	/* DATATRANS_UL_DURATION */
	#define E919000007_DATATRANS_UL_DURATION_INT 18
	/* DATATRANS_DL_DURATION */
	#define E919000007_DATATRANS_DL_DURATION_INT 19
	/* MCC */
	#define E919000007_MCC_SMALLINT 20
	/* MNC */
	#define E919000007_MNC_SMALLINT 21
	/* RAT */
	#define E919000007_RAT_TINYINT 22
	/* TIME_CELL_ID */
	#define E919000007_CELL_ID_VARCHAR 23
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000007_LOCATION_INT 24
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000007_EUTRAN_NEIGHBOR_VARCHAR 25
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000007_UTRAN_NEIGHBOR_VARCHAR 26
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000007_WLAN_VARCHAR 27
	/* DNS_DELAY */
	#define E919000007_DNS_DELAY_SMALLINT 28
	/* DNS_SUCCEED_FLAG */
	#define E919000007_DNS_SUCCEED_FLAG_TINYINT 29
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000007_TCP_SYN_SUCCEED_FLAG_TINYINT 30
	/* TCP_SYN_TIME */
	#define E919000007_TCP_SYN_TIME_INT 31
	/* TCP_RTT_STEP2 */
	#define E919000007_TCP_RTT_STEP2_INT 32
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000007_MS_ACK_TO_1STGET_DELAY_SMALLINT 33
	/* GET_TO_1STDATA_DELAY */
	#define E919000007_GET_TO_1STDATA_DELAY_SMALLINT 34
	/* FIRST_RESPONSE_CODE */
	#define E919000007_FIRST_RESPONSE_CODE_SMALLINT 35
	/* FIR_FAIL_TIME */
	#define E919000007_FIR_FAIL_TIME_INT 36
	/* TCP_WIN_SIZE */
	#define E919000007_TCP_WIN_SIZE_INT 37
	/* TCP_WIN_ZERO_COUNT */
	#define E919000007_TCP_WIN_ZERO_COUNT_SMALLINT 38
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000007_MS_WIN_STAT_TOTAL_NUM_INT 39
	/* TCP_MSS */
	#define E919000007_TCP_MSS_SMALLINT 40
	/* TCP_UL_PACKAGES */
	#define E919000007_TCP_UL_PACKAGES_INT 41
	/* TCP_DL_PACKAGES */
	#define E919000007_TCP_DL_PACKAGES_INT 42
	/* TCP_UL_RETRANS */
	#define E919000007_TCP_UL_RETRANS_INT 43
	/* TCP_DL_RETRANS */
	#define E919000007_TCP_DL_RETRANS_INT 44
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000007_TCP_UL_TIMEOUT_RETRANS_SMALLINT 45
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000007_TCP_DL_TIMEOUT_RETRANS_SMALLINT 46
	/* TCP_UL_FAST RETRANS */
	#define E919000007_TCP_UL_FAST_RETRANS_SMALLINT 47
	/* TCP_DL_FAST RETRANS */
	#define E919000007_TCP_DL_FAST_RETRANS_SMALLINT 48
	/* TCP_UL_OUTOFSEQU */
	#define E919000007_TCP_UL_OUTOFSEQU_SMALLINT 49
	/* TCP_DL_OUTOFSEQU */
	#define E919000007_TCP_DL_OUTOFSEQU_SMALLINT 50
	/* UL_RTT */
	#define E919000007_UL_RTT_SMALLINT 51
	/* RECEIVE_RTT */
	#define E919000007_RECEIVE_RTT_SMALLINT 52
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000007_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 53
	/* DL_RSRP */
	#define E919000007_DL_RSRP_TINYINT 54
	/* DL_RSRQ */
	#define E919000007_DL_RSRQ_TINYINT 55
	/* DL_SINR */
	#define E919000007_DL_SINR_INT 56
	/* DL_BLER */
	#define E919000007_DL_BLER_SMALLINT 57
	/* Reliability */
	#define E919000007_RELIABILITY_INT 58
	/* Performance */
	#define E919000007_PERFORMANCE_INT 59
	/* CHR */
	#define E919000007_CHR_INT 60

	/* Event 919000008
		China Instant message Experience Normal Log */
	/* IM_APP_NAME */
	#define E919000008_IM_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000008_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000008_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000008_SUCCEED_FLAG_TINYINT 3
	/* TIME_ZONE */
	#define E919000008_TIME_ZONE_SMALLINT 4
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000008_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 5
	/* SESSION_START_DATE */
	#define E919000008_SESSION_START_DATE_INT 6
	/* SESSION_START_TIME */
	#define E919000008_SESSION_START_TIME_INT 7
	/* SESSION_END_TIME */
	#define E919000008_SESSION_END_TIME_INT 8
	/* HOST_NAME */
	#define E919000008_HOST_NAME_SMALLINT 9
	/* URL */
	#define E919000008_URL_VARCHAR 10
	/* L7_UL_TRAFFIC */
	#define E919000008_L7_UL_TRAFFIC_INT 11
	/* L7_DL_TRAFFIC */
	#define E919000008_L7_DL_TRAFFIC_INT 12
	/* DATATRANS_UL_DURATION */
	#define E919000008_DATATRANS_UL_DURATION_INT 13
	/* DATATRANS_DL_DURATION */
	#define E919000008_DATATRANS_DL_DURATION_INT 14
	/* MCC */
	#define E919000008_MCC_SMALLINT 15
	/* MNC */
	#define E919000008_MNC_SMALLINT 16
	/* RAT */
	#define E919000008_RAT_TINYINT 17
	/* TIME_CELL_ID */
	#define E919000008_CELL_ID_VARCHAR 18
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000008_LOCATION_INT 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000008_EUTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000008_UTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000008_WLAN_VARCHAR 22
	/* DL_RSRP */
	#define E919000008_DL_RSRP_TINYINT 23
	/* DL_RSRQ */
	#define E919000008_DL_RSRQ_TINYINT 24
	/* DL_SINR */
	#define E919000008_DL_SINR_INT 25
	/* DL_BLER */
	#define E919000008_DL_BLER_SMALLINT 26

	/* Event 919000009
		China Instant message Experience Abnormal Log */
	/* IM_APP_NAME */
	#define E919000009_IM_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000009_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000009_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000009_SUCCEED_FLAG_TINYINT 3
	/* TIME_ZONE */
	#define E919000009_TIME_ZONE_SMALLINT 4
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000009_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 5
	/* SESSION_START_DATE */
	#define E919000009_SESSION_START_DATE_INT 6
	/* SESSION_START_TIME */
	#define E919000009_SESSION_START_TIME_INT 7
	/* SESSION_END_TIME */
	#define E919000009_SESSION_END_TIME_INT 8
	/* HOST_NAME */
	#define E919000009_HOST_NAME_SMALLINT 9
	/* URL */
	#define E919000009_URL_VARCHAR 10
	/* L7_UL_TRAFFIC */
	#define E919000009_L7_UL_TRAFFIC_INT 11
	/* L7_DL_TRAFFIC */
	#define E919000009_L7_DL_TRAFFIC_INT 12
	/* DATATRANS_UL_DURATION */
	#define E919000009_DATATRANS_UL_DURATION_INT 13
	/* DATATRANS_DL_DURATION */
	#define E919000009_DATATRANS_DL_DURATION_INT 14
	/* MCC */
	#define E919000009_MCC_SMALLINT 15
	/* MNC */
	#define E919000009_MNC_SMALLINT 16
	/* RAT */
	#define E919000009_RAT_TINYINT 17
	/* TIME_CELL_ID */
	#define E919000009_CELL_ID_VARCHAR 18
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000009_LOCATION_INT 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000009_EUTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000009_UTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000009_WLAN_VARCHAR 22
	/* DNS_DELAY */
	#define E919000009_DNS_DELAY_SMALLINT 23
	/* DNS_SUCCEED_FLAG */
	#define E919000009_DNS_SUCCEED_FLAG_TINYINT 24
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000009_TCP_SYN_SUCCEED_FLAG_TINYINT 25
	/* TCP_SYN_TIME */
	#define E919000009_TCP_SYN_TIME_INT 26
	/* TCP_RTT_STEP2 */
	#define E919000009_TCP_RTT_STEP2_INT 27
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000009_MS_ACK_TO_1STGET_DELAY_SMALLINT 28
	/* GET_TO_1STDATA_DELAY */
	#define E919000009_GET_TO_1STDATA_DELAY_SMALLINT 29
	/* FIRST_RESPONSE_CODE */
	#define E919000009_FIRST_RESPONSE_CODE_SMALLINT 30
	/* FIR_FAIL_TIME */
	#define E919000009_FIR_FAIL_TIME_INT 31
	/* TCP_WIN_SIZE */
	#define E919000009_TCP_WIN_SIZE_INT 32
	/* TCP_WIN_ZERO_COUNT */
	#define E919000009_TCP_WIN_ZERO_COUNT_SMALLINT 33
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000009_MS_WIN_STAT_TOTAL_NUM_INT 34
	/* TCP_MSS */
	#define E919000009_TCP_MSS_SMALLINT 35
	/* TCP_UL_PACKAGES */
	#define E919000009_TCP_UL_PACKAGES_INT 36
	/* TCP_DL_PACKAGES */
	#define E919000009_TCP_DL_PACKAGES_INT 37
	/* TCP_UL_RETRANS */
	#define E919000009_TCP_UL_RETRANS_INT 38
	/* TCP_DL_RETRANS */
	#define E919000009_TCP_DL_RETRANS_INT 39
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000009_TCP_UL_TIMEOUT_RETRANS_SMALLINT 40
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000009_TCP_DL_TIMEOUT_RETRANS_SMALLINT 41
	/* TCP_UL_FAST RETRANS */
	#define E919000009_TCP_UL_FAST_RETRANS_SMALLINT 42
	/* TCP_DL_FAST RETRANS */
	#define E919000009_TCP_DL_FAST_RETRANS_SMALLINT 43
	/* TCP_UL_OUTOFSEQU */
	#define E919000009_TCP_UL_OUTOFSEQU_SMALLINT 44
	/* TCP_DL_OUTOFSEQU */
	#define E919000009_TCP_DL_OUTOFSEQU_SMALLINT 45
	/* UL_RTT */
	#define E919000009_UL_RTT_SMALLINT 46
	/* RECEIVE_RTT */
	#define E919000009_RECEIVE_RTT_SMALLINT 47
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000009_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 48
	/* DL_RSRP */
	#define E919000009_DL_RSRP_TINYINT 49
	/* DL_RSRQ */
	#define E919000009_DL_RSRQ_TINYINT 50
	/* DL_SINR */
	#define E919000009_DL_SINR_INT 51
	/* DL_BLER */
	#define E919000009_DL_BLER_SMALLINT 52
	/* Reliability */
	#define E919000009_RELIABILITY_INT 53
	/* Performance */
	#define E919000009_PERFORMANCE_INT 54
	/* CHR */
	#define E919000009_CHR_INT 55

	/* Event 919000010
		Abroad SNS experience normal Log */
	/* SNS_APP_NAME */
	#define E919000010_SNS_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000010_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000010_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000010_SUCCEED_FLAG_TINYINT 3
	/* TIME_ZONE */
	#define E919000010_TIME_ZONE_SMALLINT 4
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000010_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 5
	/* SESSION_START_DATE */
	#define E919000010_SESSION_START_DATE_INT 6
	/* SESSION_START_TIME */
	#define E919000010_SESSION_START_TIME_INT 7
	/* SESSION_END_TIME */
	#define E919000010_SESSION_END_TIME_INT 8
	/* HOST_NAME */
	#define E919000010_HOST_NAME_SMALLINT 9
	/* URL */
	#define E919000010_URL_VARCHAR 10
	/* L7_UL_TRAFFIC */
	#define E919000010_L7_UL_TRAFFIC_INT 11
	/* L7_DL_TRAFFIC */
	#define E919000010_L7_DL_TRAFFIC_INT 12
	/* DATATRANS_UL_DURATION */
	#define E919000010_DATATRANS_UL_DURATION_INT 13
	/* DATATRANS_DL_DURATION */
	#define E919000010_DATATRANS_DL_DURATION_INT 14
	/* MCC */
	#define E919000010_MCC_SMALLINT 15
	/* MNC */
	#define E919000010_MNC_SMALLINT 16
	/* RAT */
	#define E919000010_RAT_TINYINT 17
	/* TIME_CELL_ID */
	#define E919000010_CELL_ID_VARCHAR 18
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000010_LOCATION_INT 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000010_EUTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000010_UTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000010_WLAN_VARCHAR 22
	/* DL_RSRP */
	#define E919000010_DL_RSRP_TINYINT 23
	/* DL_RSRQ */
	#define E919000010_DL_RSRQ_TINYINT 24
	/* DL_SINR */
	#define E919000010_DL_SINR_INT 25
	/* DL_BLER */
	#define E919000010_DL_BLER_SMALLINT 26

	/* Event 919000011
		Abroad SNS experience Abnormal Log */
	/* SNS_APP_NAME */
	#define E919000011_SNS_APP_NAME_VARCHAR 0
	/* SESSION_TYPE */
	#define E919000011_SESSION_TYPE_TINYINT 1
	/* LATANCY */
	#define E919000011_LATANCY_SMALLINT 2
	/* SUCCEED_FLAG */
	#define E919000011_SUCCEED_FLAG_TINYINT 3
	/* TIME_ZONE */
	#define E919000011_TIME_ZONE_SMALLINT 4
	/* DAYLIGHT_SAVING_TIME_SHIFTING */
	#define E919000011_DAYLIGHT_SAVING_TIME_SHIFTING_SMALLINT 5
	/* SESSION_START_DATE */
	#define E919000011_SESSION_START_DATE_INT 6
	/* SESSION_START_TIME */
	#define E919000011_SESSION_START_TIME_INT 7
	/* SESSION_END_TIME */
	#define E919000011_SESSION_END_TIME_INT 8
	/* HOST_NAME */
	#define E919000011_HOST_NAME_SMALLINT 9
	/* URL */
	#define E919000011_URL_VARCHAR 10
	/* L7_UL_TRAFFIC */
	#define E919000011_L7_UL_TRAFFIC_INT 11
	/* L7_DL_TRAFFIC */
	#define E919000011_L7_DL_TRAFFIC_INT 12
	/* DATATRANS_UL_DURATION */
	#define E919000011_DATATRANS_UL_DURATION_INT 13
	/* DATATRANS_DL_DURATION */
	#define E919000011_DATATRANS_DL_DURATION_INT 14
	/* MCC */
	#define E919000011_MCC_SMALLINT 15
	/* MNC */
	#define E919000011_MNC_SMALLINT 16
	/* RAT */
	#define E919000011_RAT_TINYINT 17
	/* TIME_CELL_ID */
	#define E919000011_CELL_ID_VARCHAR 18
	/* TIME_LONGITUDE_LATITUDE */
	#define E919000011_LOCATION_INT 19
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_EUTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSRP */
	#define E919000011_EUTRAN_NEIGHBOR_VARCHAR 20
	/* TIME_SERVING_CELL_ID_SERVING_CELL_RSRP_UTRAN_NEIGHBOR_NUM_NEIGHBOR_PHYSCELLID_NEIGHBOR_CARRIERFREQ_NEIGHBOR_RSCP */
	#define E919000011_UTRAN_NEIGHBOR_VARCHAR 21
	/* TIME_BSSID_NUM_BSSID_SIGNAL_STRENGTH */
	#define E919000011_WLAN_VARCHAR 22
	/* DNS_DELAY */
	#define E919000011_DNS_DELAY_SMALLINT 23
	/* DNS_SUCCEED_FLAG */
	#define E919000011_DNS_SUCCEED_FLAG_TINYINT 24
	/* TCP_SYN_SUCCEED_FLAG */
	#define E919000011_TCP_SYN_SUCCEED_FLAG_TINYINT 25
	/* TCP_SYN_TIME */
	#define E919000011_TCP_SYN_TIME_INT 26
	/* TCP_RTT_STEP2 */
	#define E919000011_TCP_RTT_STEP2_INT 27
	/* MS_ACK_TO_1STGET_DELAY */
	#define E919000011_MS_ACK_TO_1STGET_DELAY_SMALLINT 28
	/* GET_TO_1STDATA_DELAY */
	#define E919000011_GET_TO_1STDATA_DELAY_SMALLINT 29
	/* FIRST_RESPONSE_CODE */
	#define E919000011_FIRST_RESPONSE_CODE_SMALLINT 30
	/* FIR_FAIL_TIME */
	#define E919000011_FIR_FAIL_TIME_INT 31
	/* TCP_WIN_SIZE */
	#define E919000011_TCP_WIN_SIZE_INT 32
	/* TCP_WIN_ZERO_COUNT */
	#define E919000011_TCP_WIN_ZERO_COUNT_SMALLINT 33
	/* MS_WIN_STAT_TOTAL_NUM */
	#define E919000011_MS_WIN_STAT_TOTAL_NUM_INT 34
	/* TCP_MSS */
	#define E919000011_TCP_MSS_SMALLINT 35
	/* TCP_UL_PACKAGES */
	#define E919000011_TCP_UL_PACKAGES_INT 36
	/* TCP_DL_PACKAGES */
	#define E919000011_TCP_DL_PACKAGES_INT 37
	/* TCP_UL_RETRANS */
	#define E919000011_TCP_UL_RETRANS_INT 38
	/* TCP_DL_RETRANS */
	#define E919000011_TCP_DL_RETRANS_INT 39
	/* TCP_UL_TIMEOUT_RETRANS */
	#define E919000011_TCP_UL_TIMEOUT_RETRANS_SMALLINT 40
	/* TCP_DL_TIMEOUT_RETRANS */
	#define E919000011_TCP_DL_TIMEOUT_RETRANS_SMALLINT 41
	/* TCP_UL_FAST RETRANS */
	#define E919000011_TCP_UL_FAST_RETRANS_SMALLINT 42
	/* TCP_DL_FAST RETRANS */
	#define E919000011_TCP_DL_FAST_RETRANS_SMALLINT 43
	/* TCP_UL_OUTOFSEQU */
	#define E919000011_TCP_UL_OUTOFSEQU_SMALLINT 44
	/* TCP_DL_OUTOFSEQU */
	#define E919000011_TCP_DL_OUTOFSEQU_SMALLINT 45
	/* UL_RTT */
	#define E919000011_UL_RTT_SMALLINT 46
	/* RECEIVE_RTT */
	#define E919000011_RECEIVE_RTT_SMALLINT 47
	/* TCP_TIMEOUT_RELEASE_FLAG */
	#define E919000011_TCP_TIMEOUT_RELEASE_FLAG_TINYINT 48
	/* DL_RSRP */
	#define E919000011_DL_RSRP_TINYINT 49
	/* DL_RSRQ */
	#define E919000011_DL_RSRQ_TINYINT 50
	/* DL_SINR */
	#define E919000011_DL_SINR_INT 51
	/* DL_BLER */
	#define E919000011_DL_BLER_SMALLINT 52
	/* Reliability */
	#define E919000011_RELIABILITY_INT 53
	/* Performance */
	#define E919000011_PERFORMANCE_INT 54
	/* CHR */
	#define E919000011_CHR_INT 55

	/* Event 919000030
		TOP5 TRAFFIC APP */
	/* APP NAME */
	#define E919000030_APP_NAME_INT 0
	/* TOTAL_TRAFFIC_1DAY */
	#define E919000030_TOTAL_TRAFFIC_1DAY_INT 1
	/* HOST_NAME */
	#define E919000030_HOST_NAME_SMALLINT 2
	/* IP_ADDRESS */
	#define E919000030_IP_ADDRESS_INT 3

	/* Event 919000031
		TOP5 DURATION APP */
	/* APP NAME */
	#define E919000031_APP_NAME_INT 0
	/* TOTAL_DURATION_1DAY */
	#define E919000031_TOTAL_DURATION_1DAY_INT 1
	/* HOST_NAME */
	#define E919000031_HOST_NAME_SMALLINT 2
	/* IP_ADDRESS */
	#define E919000031_IP_ADDRESS_INT 3

/*** Security events' keys ***/

	/* Event 940000000
		HKIP_INTERCEPT_ATTACK_INFO */
	/* attack type */
	#define E940000000_ATKTYPE_INT 0
	/* attack process name */
	#define E940000000_PROCESSNAME_VARCHAR 1
	/* attack description */
	#define E940000000_ATKDESC_VARCHAR 2
