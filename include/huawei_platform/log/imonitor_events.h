...
const unsigned short E901006000[4]
	 = {4, 4, 116, 4};
const struct imonitor_event_index Reliability_events[26]
	= { {901000000, E901000000, 4}, {901000001, E901000001, 3},
		...
		{901004000, E901004000, 7}, {901004001, E901004001, 7},
		{901004002, E901004002, 4}, {901004003, E901004003, 3},
...
const unsigned short E903009000[64]
	 = {2, 2, 2, 3, 3, 3, 3, 2, 3, 3,
		...
		2, 2, 2, 2, 3, 3, 3, 3, 3, 3,
		3, 3, 3, 3};
const struct imonitor_event_index PowerThermal_events[40]
	= { {903001000, E903001000, 19}, {903001001, E903001001, 7},
		...
		{903001024, E903001024, 12}, {903002000, E903002000, 4},
		...
		{903002011, E903002011, 3}, {903003000, E903003000, 8},
...
const unsigned short E928009000[5]
	 = {4, 164, 164, 1124, 4};
const struct imonitor_event_index DMD_events[725]
	= { {920001003, E920001003, 5}, {920001004, E920001004, 5},
		...
		{926011001, E926011001, 5}, {926011002, E926011002, 5},
		{926011003, E926011003, 5}, {926011004, E926011004, 5},
		{926011005, E926011005, 5}, {926011006, E926011006, 5},
		{926011007, E926011007, 5}, {926011008, E926011008, 5},
		{926011009, E926011009, 5}, {926011010, E926011010, 5},
		{926011011, E926011011, 5}, {926011012, E926011012, 5},
		{926011013, E926011013, 5}, {926011014, E926011014, 5},
		{926011015, E926011015, 5}, {926011016, E926011016, 5},
		{926011017, E926011017, 5}, {926011018, E926011018, 5},
		{926011019, E926011019, 5}, {926011020, E926011020, 5},
		{926011021, E926011021, 5}, {926011022, E926011022, 5},
...
const unsigned short E907046004[3]
	 = {4, 228, 228};
const struct imonitor_event_index Application_events[234]
...
const unsigned short E916019202[4]
	 = {4, 4, 4, 4};
const struct imonitor_event_index Audio_events[41]
	= { {916000001, E916000001, 2}, {916000002, E916000002, 2},
		...
		{916019001, E916019001, 4}, {916019002, E916019002, 4},
		{916019003, E916019003, 4}, {916019004, E916019004, 4},
		{916019005, E916019005, 4}, {916019006, E916019006, 4},
		{916019007, E916019007, 7}, {916019101, E916019101, 11},
		{916019102, E916019102, 9}, {916019103, E916019103, 5},
		{916019104, E916019104, 6}, {916019201, E916019201, 6},
		{916019202, E916019202, 4} };
...
/*** Ecom events ***/
const unsigned short E919000000[26]
	 = {164, 3, 2, 3, 3, 4, 4, 4, 164, 228,
		4, 4, 4, 4, 3, 3, 2, 108, 4, 375,
		355, 1636, 2, 2, 4, 3};
const unsigned short E919000001[55]
	 = {164, 3, 2, 3, 3, 4, 4, 4, 3, 228,
		4, 4, 4, 4, 3, 3, 2, 108, 4, 375,
		355, 1636, 3, 2, 2, 4, 4, 3, 3, 3,
		4, 4, 3, 4, 3, 4, 4, 4, 4, 3,
		3, 3, 3, 3, 3, 3, 3, 2, 2, 2,
		4, 3, 4, 4, 4};
const unsigned short E919000002[29]
	 = {3, 2, 2, 3, 3, 3, 3, 3, 4, 4,
		4, 3, 228, 4, 4, 4, 4, 3, 3, 2,
		108, 4, 375, 355, 1636, 2, 2, 4, 3};
const unsigned short E919000003[58]
	 = {3, 2, 2, 3, 3, 3, 3, 3, 4, 4,
		4, 3, 228, 4, 4, 4, 4, 3, 3, 2,
		108, 4, 375, 355, 1636, 3, 2, 2, 4, 4,
		3, 3, 3, 4, 4, 3, 4, 3, 4, 4,
		4, 4, 3, 3, 3, 3, 3, 3, 3, 3,
		2, 2, 2, 4, 3, 4, 4, 4};
const unsigned short E919000004[28]
	 = {164, 2, 3, 2, 2, 3, 3, 4, 4, 4,
		3, 228, 4, 4, 4, 4, 3, 3, 2, 108,
		4, 375, 355, 1636, 2, 2, 4, 3};
const unsigned short E919000005[57]
	 = {164, 2, 3, 2, 2, 3, 3, 4, 4, 4,
		3, 228, 4, 4, 4, 4, 3, 3, 2, 108,
		4, 375, 355, 1636, 3, 2, 2, 4, 4, 3,
		3, 3, 4, 4, 3, 4, 3, 4, 4, 4,
		4, 3, 3, 3, 3, 3, 3, 3, 3, 2,
		2, 2, 4, 3, 4, 4, 4};
const unsigned short E919000006[32]
	 = {164, 3, 3, 2, 3, 3, 4, 2, 2, 3,
		3, 4, 4, 4, 3, 228, 4, 4, 4, 4,
		3, 3, 2, 108, 4, 375, 355, 1636, 2, 2,
		4, 3};
const unsigned short E919000007[61]
	 = {164, 3, 3, 2, 3, 3, 4, 2, 2, 3,
		3, 4, 4, 4, 3, 228, 4, 4, 4, 4,
		3, 3, 2, 108, 4, 375, 355, 1636, 3, 2,
		2, 4, 4, 3, 3, 3, 4, 4, 3, 4,
		3, 4, 4, 4, 4, 3, 3, 3, 3, 3,
		3, 3, 3, 2, 2, 2, 4, 3, 4, 4,
		4};
const unsigned short E919000008[27]
	 = {164, 2, 3, 2, 3, 3, 4, 4, 4, 3,
		228, 4, 4, 4, 4, 3, 3, 2, 108, 4,
		375, 355, 1636, 2, 2, 4, 3};
const unsigned short E919000009[56]
	 = {164, 2, 3, 2, 3, 3, 4, 4, 4, 3,
		228, 4, 4, 4, 4, 3, 3, 2, 108, 4,
		375, 355, 1636, 3, 2, 2, 4, 4, 3, 3,
		3, 4, 4, 3, 4, 3, 4, 4, 4, 4,
		3, 3, 3, 3, 3, 3, 3, 3, 2, 2,
		2, 4, 3, 4, 4, 4};
const unsigned short E919000010[27]
	 = {164, 2, 3, 2, 3, 3, 4, 4, 4, 3,
		228, 4, 4, 4, 4, 3, 3, 2, 108, 4,
		375, 355, 1636, 2, 2, 4, 3};
const unsigned short E919000011[56]
	 = {164, 2, 3, 2, 3, 3, 4, 4, 4, 3,
		228, 4, 4, 4, 4, 3, 3, 2, 108, 4,
		375, 355, 1636, 3, 2, 2, 4, 4, 3, 3,
		3, 4, 4, 3, 4, 3, 4, 4, 4, 4,
...
const unsigned short E919000031[4]
	 = {4, 4, 3, 4};
const struct imonitor_event_index Ecom_events[14]
	= { {919000000, E919000000, 26}, {919000001, E919000001, 55},
		{919000002, E919000002, 29}, {919000003, E919000003, 58},
		{919000004, E919000004, 28}, {919000005, E919000005, 57},
		{919000006, E919000006, 32}, {919000007, E919000007, 61},
		{919000008, E919000008, 27}, {919000009, E919000009, 56},
		{919000010, E919000010, 27}, {919000011, E919000011, 56},
		{919000030, E919000030, 4}, {919000031, E919000031, 4} };

/*** Security events ***/
const unsigned short E940000000[3]
	 = {4, 116, 356};
const struct imonitor_event_index Security_events[1]
	= { {940000000, E940000000, 3} };

/* All events index table */
const unsigned int imonitor_modules_count = 18;
const struct imonitor_module_index imonitor_modules_table[18] = {
	{Reliability_events, 901000000, 901999999, 26},
	{Performance_events, 902000000, 902999999, 43},
	{PowerThermal_events, 903000000, 903999999, 40},
	{CHR_events, 904000000, 904999999, 13},
	{DMD_events, 920000000, 939999999, 725},
	{Application_events, 907000000, 907999999, 234},
	...
	{Audio_events, 916000000, 916999999, 41},
	{SpikeDog_events, 917000000, 917999999, 1},
	{Camera_events, 918000000, 918999999, 14},
	{Ecom_events, 919000000, 919999999, 14},
	{Security_events, 940000000, 940999999, 1},
};
