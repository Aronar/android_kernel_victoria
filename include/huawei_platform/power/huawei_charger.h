...
/*Time configuration for charger recheck by bc_again*/
#define RECHECK_INIT_TIME_INTERVAL (2000)
#define RECHECK_REGULATOR_TIME_INTERVAL (30000)
/*************************struct define area***************************/
