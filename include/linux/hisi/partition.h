...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_PATCH_A,          1032 *1024,  32*1024,       EMMC_USER_PART},/* patch         32M    p43*/
  {PART_VERSION_A,        1064*1024,  32*1024,        EMMC_USER_PART},/* version       32M     p44*/
  {PART_VENDOR_A,         1096*1024,  784*1024,      EMMC_USER_PART},/* vendor         784M   p45*/
  {PART_PRODUCT_A,        1880*1024, 192*1024,      EMMC_USER_PART},/* product         192M   p46*/
  {PART_CUST_A,           2072*1024, 192*1024,      EMMC_USER_PART},/* cust            192M   p47*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2264*1024, 3552*1024,     EMMC_USER_PART},/* system          3552M  p48*/
  {PART_RESERVED5,        5816*1024, 128*1024,       EMMC_USER_PART},/* reserved5      128M   p49*/
  {PART_USERDATA,         5944*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p50*/
  #else
  {PART_SYSTEM_A,         2264*1024, 4688*1024,     EMMC_USER_PART},/* system          4688M  p48*/
  {PART_RESERVED5,        6952*1024, 128*1024,       EMMC_USER_PART},/* reserved5      128M    p49*/
  {PART_USERDATA,         7080*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G    p50*/
  #endif
...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_MODEMNVM_SYSTEM,  172*1024,  4*1024,        EMMC_USER_PART},/* modemnvm system 4M     p15*/
  {PART_SPLASH2,          176*1024,  80*1024,       EMMC_USER_PART},/* splash2         80M    p16*/
  {PART_CACHE,            256*1024,  256*1024,        EMMC_USER_PART},/* cache           256M     p17*/
  {PART_BOOTFAIL_INFO,    512*1024,  2*1024,        EMMC_USER_PART},/* bootfail info   2MB    p18*/
  {PART_MISC,             514*1024,  2*1024,        EMMC_USER_PART},/* misc            2M     p19*/
  {PART_HISEE_ENCOS,        516*1024,  4*1024,       EMMC_USER_PART},/* hisee_encos       4M    p20*/
  {PART_RESERVED2,        520*1024,  28*1024,       EMMC_USER_PART},/* reserved2       32M    p21*/
  {PART_HHEE,        548*1024,  4*1024,        EMMC_USER_PART},/* PART_RESERVED10       4M     p22*/
  ...
  {PART_RECOVERY2_A,      652*1024,  64*1024,       EMMC_USER_PART},/* recovery2       64M    p35*/
  {PART_SENSORHUB_A,      716*1024,  16*1024,       EMMC_USER_PART},/* sensorhub       16M    p36*/
  {PART_BOOT_A,           732*1024,  32*1024,       EMMC_USER_PART},/* boot            32M    p37*/
  {PART_RECOVERY_A,       764*1024,  64*1024,       EMMC_USER_PART},/* recovery        64M    p38*/
  {PART_DTS_A,            828*1024,  16*1024,       EMMC_USER_PART},/* dtimage         16M    p39*/
  {PART_TRUSTFIRMWARE_A,  844*1024,  2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p40*/
  {PART_MODEM_FW_A,       846*1024,  56*1024,       EMMC_USER_PART},/* modem_fw        56M    p40*/
  {PART_RESERVED4_A,      902*1024,  49*1024,       EMMC_USER_PART},/* reserved4A      49M    p41*/
  {PART_DDR_PARA_A,      951*1024,  1*1024,       EMMC_USER_PART},/* DDR_PARA      1M    p42*/
  {PART_MODEMNVM_UPDATE_A,952*1024,  80*1024,       EMMC_USER_PART},/* modemnvm update 80M    p43*/
  {PART_PATCH_A,          1032 *1024,  32*1024,       EMMC_USER_PART},/* patch           16M    p44*/
  {PART_VERSION_A,        1064*1024,  24*1024,        EMMC_USER_PART},/* version         8M     p45*/
  {PART_VENDOR_A,         1088*1024,  784*1024,      EMMC_USER_PART},/* vendor          704M   p46*/
  {PART_PRODUCT_A,        1872*1024, 192*1024,      EMMC_USER_PART},/* product         240M   p47*/
  {PART_CUST_A,           2064*1024, 192*1024,      EMMC_USER_PART},/* cust            256M   p48*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2256*1024, 3552*1024,     EMMC_USER_PART},/* system          3697M  p49*/
  {PART_RESERVED5,        5808*1024, 128*1024,       EMMC_USER_PART},/* reserved5       64M    p50*/
  {PART_USERDATA,         5936*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p51*/
  #else
  {PART_SYSTEM_A,         2256*1024, 4688*1024,     EMMC_USER_PART},/* system          4000M  p49*/
  {PART_RESERVED5,        6944*1024, 128*1024,       EMMC_USER_PART},/* reserved5       64M    p50*/
  {PART_USERDATA,         7072*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G    p51*/
  #endif
  {"0", 0, 0, 0},                                        /* total 11848M*/
};
#ifdef CONFIG_HISI_STORAGE_UFS_PARTITION
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_BOOTFAIL_INFO,    504*1024,  2*1024,        UFS_PART_3},/* bootfail info   2MB    p14*/
  {PART_MISC,             506*1024,  2*1024,        UFS_PART_3},/* misc            2M     p15*/
  {PART_HISEE_ENCOS,        508*1024,  4*1024,       UFS_PART_3},/* hisee_encos       4M    p16*/
  {PART_RESERVED2,        512*1024,  28*1024,       UFS_PART_3},/* reserved2       32M    p17*/
  {PART_HHEE,        540*1024,  4*1024,        UFS_PART_3},/* PART_RESERVED10       4M     p18*/
  ...
  {PART_RECOVERY2_A,      644*1024,  64*1024,       UFS_PART_3},/* recovery2       64M    p31*/
  {PART_SENSORHUB_A,      708*1024,  16*1024,       UFS_PART_3},/* sensorhub       16M    p32*/
  {PART_BOOT_A,           724*1024,  32*1024,       UFS_PART_3},/* boot            32M    p33*/
  {PART_RECOVERY_A,       756*1024,  64*1024,       UFS_PART_3},/* recovery        64M    p34*/
  {PART_DTS_A,            820*1024,  16*1024,       UFS_PART_3},/* dtimage         16M    p35*/
  {PART_TRUSTFIRMWARE_A,  836*1024,  2*1024,        UFS_PART_3},/* trustfirmware   2M     p36*/
  {PART_MODEM_FW_A,       838*1024,  56*1024,       UFS_PART_3},/* modem_fw        56M    p36*/
  {PART_RESERVED4_A,      894*1024,  49*1024,       UFS_PART_3},/* reserved4A      49M    p37*/
  {PART_DDR_PARA_A,       943*1024,  1*1024,        UFS_PART_3},/* DDR_PARA        1M     p38*/
