...
enum {
	HI6403_CODEC_ANA_RWREG_106_OCP_0 = 0,
	HI6403_CODEC_ANA_RWREG_106_OCP_300,
	HI6403_CODEC_ANA_RWREG_106_OCP_400,
	HI6403_CODEC_ANA_RWREG_106_OCP_700,
};
...
struct hi64xx_dsp_config {
	...
	unsigned int ir_switch_gpio;
	unsigned int ana_rwreg_106;
	unsigned int ana_rwreg_106_ocp;
};
