...
#define A7ISP_RDR_USE_APCTRL        (1 << 31)
#define A7ISP_RDR_RESERVE_30        (1 << 30)
#define A7ISP_RDR_RESERVE_29        (1 << 29)
#define A7ISP_RDR_RESERVE_28        (1 << 28)
#define A7ISP_RDR_RESERVE_27        (1 << 27)
#define A7ISP_RDR_RESERVE_26        (1 << 26)
#define A7ISP_RDR_RESERVE_25        (1 << 25)
#define A7ISP_RDR_RESERVE_24        (1 << 24)
#define A7ISP_RDR_RESERVE_23        (1 << 23)
#define A7ISP_RDR_RESERVE_22        (1 << 22)
#define A7ISP_RDR_RESERVE_21        (1 << 21)
#define A7ISP_RDR_RESERVE_20        (1 << 20)
#define A7ISP_RDR_RESERVE_19        (1 << 19)
#define A7ISP_RDR_RESERVE_18        (1 << 18)
#define A7ISP_RDR_RESERVE_17        (1 << 17)
#define A7ISP_RDR_RESERVE_16        (1 << 16)
#define A7ISP_RDR_RESERVE_15        (1 << 15)
#define A7ISP_RDR_RESERVE_14        (1 << 14)
#define A7ISP_RDR_RESERVE_13        (1 << 13)
#define A7ISP_RDR_RESERVE_12        (1 << 12)
#define A7ISP_RDR_RESERVE_11        (1 << 11)
#define A7ISP_RDR_RESERVE_10               (1 << 10)
#define A7ISP_RDR_RESERVE_9                 (1 << 9)
#define A7ISP_RDR_RESERVE_8                 (1 << 8)
#define A7ISP_RDR_RESERVE_7                 (1 << 7)
#define A7ISP_RDR_RESERVE_6                 (1 << 6)
#define A7ISP_RDR_LEVEL_TASK                (1 << 5)
#define A7ISP_RDR_LEVEL_IRQ                  (1 << 4)
#define A7ISP_RDR_LEVEL_CVDR                (1 << 3)
#define A7ISP_RDR_LEVEL_ALGO                (1 << 2)
#define A7ISP_RDR_LEVEL_LAST_WORD     (1 << 1)
#define A7ISP_RDR_LEVEL_TRACE              (1 << 0)
#define A7ISP_RDR_LEVEL_MASK                 (0x7FFFFFFF)
#define RDR_CHOOSE_TYPE                         (RDR_LOG_TRACE | RDR_LOG_LAST_WORD)
#define A7ISP_DEFAULT_RDR_LEVEL             RDR_CHOOSE_TYPE
